...
function Nav() {
  ...
  return (
    <div>
        <header>
            <h4 className='ms-md-5'><img className='mt-5' src={logo} alt="svg image" /></h4>
            <nav ref={navRef} className='pb-2'>
                ...
                <button className='ms-5 signupbtn'><NavLink onClick={showNavbar} to='/signup'>Register</NavLink></button>
